import { Trade, TradeType } from 'jetswap-sdk-new'
import React, { useMemo, useState } from 'react'
import { Text, Button } from 'jetswap-uikit-new'
        ...
        <RowBetween>
          <RowFixed>
            ...
            <QuestionHelper
              text={TranslateString(
                999,
                'For each trade a 0.3% fee is paid. 0.25% goes to liquidity providers and 0.05% goes to the JetSwap treasury.'
              )}
            />
          </RowFixed>
          <Text fontSize="14px">
